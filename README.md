...
## CMS
This project is configured to work out of the box with Forestry, just click the button below, and you're ready to go.
...
## Deploy
You can deploy this site with Netlify with just a few clicks.
Only think you'll have to do is to 